...
import com.msd117.cryptocompose.detail.data.model.Coin
import com.msd117.cryptocompose.detail.data.model.ContractAddress
import com.msd117.cryptocompose.detail.data.model.Platform
...
import com.msd117.cryptocompose.detail.presenter.model.ContractAddress as DomainContractAddress
...
class FetchCoinDetailInfoHelper @Inject constructor(private val fetchInfoUseCase: FetchInfoUseCase) {
    ...
    private fun Coin.toDomain(): com.msd117.cryptocompose.detail.presenter.model.Coin {
        return com.msd117.cryptocompose.detail.presenter.model.Coin(
            id = id,
            name = name,
            symbol = symbol,
            slug = slug
